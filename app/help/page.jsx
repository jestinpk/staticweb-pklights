  ...
  return (
    <SubpageShell eyebrow="Customer Help" title="How PK LIGHTS works" intro="A simple guide to our wholesale business, ordering process, delivery coverage and conditions.">
      <section className="info-content">
        <div className="quick-answer"><b>In one line</b><p>We help shops and project buyers source lighting products in wholesale quantities and send confirmed orders through parcel services.</p><a href="/staticweb-pklights/quote.html">Request a quotation →</a></div>
